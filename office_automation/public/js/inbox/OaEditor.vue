...
export default {
	...
	data() {
		return {
			...
			// All free (SIL OFL), self-hosted via oa_fonts.css — render everywhere.
			fonts: [
				{ label: "وزیرمتن", stack: "'Vazirmatn', Tahoma, sans-serif" },
				{ label: "شبنم", stack: "'Shabnam', Tahoma, sans-serif" },
				{ label: "استعداد", stack: "'Estedad', Tahoma, sans-serif" },
				{ label: "ساحل", stack: "'Sahel', Tahoma, sans-serif" },
				{ label: "صمیم", stack: "'Samim', Tahoma, sans-serif" },
				{ label: "تنها", stack: "'Tanha', Tahoma, serif" },
				{ label: "گندم", stack: "'Gandom', Tahoma, sans-serif" },
				{ label: "پرستو", stack: "'Parastoo', Tahoma, sans-serif" },
				{ label: "ناهید", stack: "'Nahid', Tahoma, sans-serif" },
				{ label: "لاله‌زار", stack: "'Lalezar', Tahoma, cursive" },
			],
		};
	},
	computed: {
